#include "Events.h"
#include "../Windows/WindowsHelpers.h"
...
namespace Engine
{
	...
	{
		m_Handle = CreateEvent(NULL, TRUE, i_bInitiallySignaled, (LPCWSTR)i_pName);
	...
	{
		m_Handle = CreateEvent(NULL, FALSE, i_bInitiallySignaled, (LPCWSTR)i_pName);
