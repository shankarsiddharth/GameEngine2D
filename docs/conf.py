...
breathe_projects = {
    "GameEngine2D": "./doxygen/xml"
}
breathe_default_project = "GameEngine2D"
...
exhale_args = {
    ...
    "pageLevelConfigMeta": ":github_url: https://github.com/shankarsiddharth/GameEngine2D",
    ############################################################################
...
../src/Library/ \
../src/GLib/ \
../src/Engine/FileLoader/data/ \
../src/Engine/ThirdParty/ \
../src/Exports/ \
../src/MonsterChaseGame/data/
# EXCLUDE_SYMBOLS = 
GENERATE_HTML = YES
GENERATE_LATEX = NO
GENERATE_XML = YES
...
html_theme_options: Dict[str, Any] = {
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/shankarsiddharth/GameEngine2D",
            "html": """
    ...
    "source_repository": "https://github.com/shankarsiddharth/GameEngine2D/",
    "source_branch": "main",
